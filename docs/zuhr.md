...
**Method:** The trailing limb of the sun is at the observer's upper meridian. The time is also given in terms of shadow increase over transit for a 2m gnomon, where the increase can be set according to user preference. The default is 1mm. Positions are corrected for refraction.