# Ẓuhr
Ẓuhr begins after [Istiwāʾ](/istiwa)

<note>The time shown is when the disc of the sun has crossed the upper meridian and is entirely in the West. A second time is also shown (in the web version) in terms of shadow increase over transit for a 2m gnomon. Various shadow increases are documented by [King 2003](https://brill.com/abstract/title/7640), most notably one twelfth and one quarter of a gnomon.</note>
...
**Method:** The trailing limb of the sun is at the observer's upper meridian. In the web version, the time is also given in terms of shadow increase over transit for a 2m gnomon, where the increase can be set according to user preference. The default is 1mm. Positions are corrected for refraction.